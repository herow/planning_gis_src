...
class APP_EXPORT QgisApp : public QMainWindow, private Ui::MainWindow
{
  ...
  public:
	...
	QgsPlanningToolBox* getZhengZhiGuiHua(){return mPlanningToolBox;}
	QgsBrowserDockWidget* getBrowserDockWidget(){return mBrowserWidget;}
	QDockWidget* getLayerTreee(){return mLayerTreeDock;}
	QDockWidget* getLayerOrder(){return mLayerOrderDock;}
	QDockWidget* getOverview(){ return mOverviewDock;}
